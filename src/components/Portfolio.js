...
const Portfolio = () => {
  return (
    <>
      <div className="my-6 py-4" id="portfolio">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3">
              <div className="m-2 text-justify text-sm">
                ...
                <div className="text-md font-medium">
                  ...
                  <p className="text-left pt-2">
                    Pengu Inventive is a direct to customer brand. Which started
                    with mission to be leader in Space saving furniture.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3">
              <div className="m-2 text-justify text-sm">
                ...
                <div className="text-md font-medium">
                  <p className="text-left">
                    Easily Track the location by fetching the current
                    coordinates of the user.
                  </p>
                  <p className="text-left pt-2">
                    We can easily get the Lattitude and Longitude that will help
                    to fetch the user current location. This is design in
                    Flutter Framework.
                  </p>
                </div>
              </div>
