              ...
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                    <div>
                        ...
                        From maintaining PC, implementing network equipments, and other devices like Fax and Printers. PC, network equipements, fax, printers
                        </p>
                    </div>
                ...
                <div className="m-auto max-w-6xl p-4 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            font-bold">Analysis & <span className='font-semibold'>Strategy</span></h3>
                            <div>
                                <p className='my-3 text-base mx-2  text-gray-600 font-medium'>We don’t only listen to your needs, we dive deep into historic performance data and identify what works and what doesn’t. This fuels our information architecture, content strategy, and design.</p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
                            ...
                            <h3 className="text-3xl  text-blue-900 font-bold">Post <span className='font-semibold'>Launch</span></h3>
                            <div>
                                <p className='my-4 text-base text-gray-600 font-medium mx-2'>Post-launch on digital marketing efforts, web design changes, development improvements, or simply keeping their website up-to-date with the latest browser and security updates.</p>
                            </div>
                        </div>
